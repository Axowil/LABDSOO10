...
public class UsuarioDAO{
        ...
        try (Connection conn = conexion.getConnection();
            ...
            if (rs.next()) {
                ...
                switch (tipo) {
                    ...
                    case "EMPLEADO":
                        Empleado empleado = new Empleado(dni, nombre, apellido, "EMP-00" + rs.getInt("id"), "Staff", "General");
    ...
    public boolean crearUsuario(String nombreUsuario, String password, String tipo) {
        String sql = "INSERT INTO usuarios (nombre_usuario, contrasena, tipo_usuario, estado) VALUES (?, ?, ?, 1)";
