...
public class FrmCrearCuentaAhorros extends JFrame {
	private JTextField txtDni, txtSaldoInicial;
	private JButton btnCrear;

	public FrmCrearCuentaAhorros() {
		setTitle("Crear Cuenta de Ahorros");
		setSize(350, 180);
		...
		btnCrear.addActionListener(e -> crearCuentaAhorros());
	}
	...
	private void crearCuentaAhorros() {
		...
		String numeroCuenta = String.format("AHO-%03d", gestorBanco.getCuentas().size() + 1);
		boolean creada = gestorBanco.crearCuentaAhorros(numeroCuenta, saldoInicial, cliente);
		if (creada) {
