...
public class FrmRetiroparaCliente extends JFrame {
	private JTextField txtDni, txtMonto, txtCuenta;
	private JButton btnRetirar;

	public FrmRetiroparaCliente() {
		setTitle("Retiro para Cliente");
		setSize(400, 220);
	...
	private void retirar() {
		...
		var retiro = gestorBanco.realizarRetiro(numeroCuenta, monto, "VENTANILLA", "Sucursal");
		if (retiro != null) {
